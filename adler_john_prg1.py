 ...
 *         on this program.
 *
 * Description: This program will convert any measurement of miles/hour to
 *              barleycorns/day, furlongs/fortnight, mach number, and a
 ...
 *         and the percentage of the speed of light. The original speed in
 *         miles/hour is also output.
 *
'''
